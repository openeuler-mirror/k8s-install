set_version_120(){
    ...
    export CRI_TOOLS_VERSION="1.22.0"
    export RUNC_VERSION="1.1.12-1"
    export CONTAINERD_VERSION="1.5.6-1"
    export DOCKER_CLI_VERSION="20.10.12-1"
    export DOCKER_VERSION="20.10.12-1"
...
set_version_129(){
    ...
    export KUBERNETES_KUBELET_VERSION="1.29.1"
    export KUBERNETES_CLIENT_VERSION="1.29.1"
    export KUBERNETES_NODE_VERSION="1.29.1"
    export KUBERNETES_KUBEADM_VERSION="1.29.1"
    export KUBERNETES_MASTER_VERSION="1.29.1"
...
export FLN_IMAGE_REPO="registry.cn-hangzhou.aliyuncs.com/k8s-install-flannel"
